          ...
          <div class="fc_section_wrap">
            <ul>
                <li class="admin_top_input">
                   <input_default width="150px" height="30px" v-bind:defaultObj="defaultObjs"></input_default>
                   专业选择：
                    <li style="height:30px;margin-bottom:10px;position:relative">
...
export default {
        ...
        return {
            ...
            btnobj:{ background:'#449D44',
             ...
             item:{
                         ...
                         height:30,
                         defaultStr:{value:""},
                         selectorStyle:{'width':'150px','height':'30px'},
                         options:[],
      ...
      components:{fcheader,btn_add,btn,input_default,tables,addAlert,adminStore,selector},
      mounted:function(){
