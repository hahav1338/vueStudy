...
//主页
    ...
    .controller('MycourseCtrl', function($scope, courseFirst, courseSecond,$http,$rootScope) {
        ...
        //我的课程数据 请求
        $http.get($rootScope.URLAdmin+'/Handler/OnCourseHandler.ashx?action=mycourse&userName='+$rootScope.userStudent.userName,'')
            .success(function(response){
                $scope.dl_tf=false;
                //console.log(response.data);
                $scope.itemFir = response.data;
                //收藏课程数据
                $http.get($rootScope.URLAdmin+'/Handler/OnCourseHandler.ashx?action=mycollection&userName='+$rootScope.userStudent.userName,'')
                    .success(function(response){
                        //console.log(response.data);
    ...
    .controller('PersonalCtrl', function($scope,$http,$rootScope) {
        ...
        var isLoginUser={//o.hasOwnProperty("x")
            userName:$rootScope.hasOwnProperty("userStudent")?$rootScope.userStudent.userName:""
        };
    ...
    .controller('InformationCtrl', function($scope,$http,$rootScope) {
        ...
        //获取个人信息isLogin
        $http.get($rootScope.URLAdmin+"/Handler/OnCourseHandler.ashx?action=returnuserinfo&userName="+($rootScope.hasOwnProperty("userStudent")?typeof $rootScope.userStudent=="object"?$rootScope.userStudent.userName:"":""),'')
            .success(function(response){
                console.log(response)
        ...
        //退出
        var quitUser={
            userName:$rootScope.hasOwnProperty("userStudent")?typeof $rootScope.userStudent=="object"?$rootScope.userStudent.userName:"":""
        };
        $scope.quit=function(){
    ...
    .controller('StudyCtrl', function($scope,$stateParams,studyList,pingjiaList,$ionicModal,$http,$rootScope,$ionicPopup ) {
        ...
        var isLoginUser={
            userName:$rootScope.userStudent.userName,
            courseId: $stateParams.myId
        };
        $http.post($rootScope.URLAdmin+'/Handler/UserHandler.ashx?action=isLogin',isLoginUser)
            .success(function(response){
